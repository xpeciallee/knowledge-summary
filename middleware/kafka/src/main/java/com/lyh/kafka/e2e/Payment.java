...
public class Payment extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4841569504884778303L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Payment\",\"namespace\":\"com.lyh.kafka.e2e\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"id\",\"type\":\"int\"}]}");
   ...
   */
  public Payment(java.lang.CharSequence name, java.lang.Integer id) {
    this.name = name;
    this.id = id;
  }
   ...
   */
  public static com.lyh.kafka.e2e.Payment.Builder newBuilder() {
    return new com.lyh.kafka.e2e.Payment.Builder();
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static com.lyh.kafka.e2e.Payment.Builder newBuilder(com.lyh.kafka.e2e.Payment.Builder other) {
    return new com.lyh.kafka.e2e.Payment.Builder(other);
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static com.lyh.kafka.e2e.Payment.Builder newBuilder(com.lyh.kafka.e2e.Payment other) {
    return new com.lyh.kafka.e2e.Payment.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Payment>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.lyh.kafka.e2e.Payment.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.lyh.kafka.e2e.Payment other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lyh.kafka.e2e.Payment.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lyh.kafka.e2e.Payment.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lyh.kafka.e2e.Payment.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lyh.kafka.e2e.Payment.Builder clearId() {
